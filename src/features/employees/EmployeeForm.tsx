...
font-medium"
        ...
        >
          ...
          <select
            ...
            id="departments" {...register("department_id", {required: "Choose one"})}
          >
            <option value=""></option>
            {departments &&
        ...
        <div className="w-full flex gap-5 justify-end mt-11">
          <button
            onClick={() => setCoworkerWindow(false)}
            type="button"
            className=" px-4 py-2.5 rounded-[5px] outline -outline-offset-1 outline-violet-600 text-[#343A40]
text-base
font-normal"
          >
            გაუქმება
          ...
          <button
            className="text-white px-5 py-2.5 bg-violet-600 rounded-[5px]"
            type="submit"
          >
